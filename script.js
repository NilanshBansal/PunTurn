puns=[
    {"pun": "Q: How many programmers does it take to change a light bulb?","punchline": "A: None. It's a hardware problem."},
    {"pun": "Q: What does a proud computer call its little son?","punchline": "A: A microchip off the old block."},
    {"pun": "Q: What is another name for a computer virus?","punchline": "A: A terminal illness"},
    {"pun": "Q: Why did the computer spy quit?","punchline": "A: They couldn't hack it anymore!"},
    {"pun": "Q: What did the motherboard say to the new software?","punchline": "A: I'll show you who's Dos!"},
    {"pun": "Q: What does a floppy disk do when it needs a break?","punchline": "A: It goes for a C: drive!"},
    {"pun": "Q: Why was the computer geek disappointed by the zoo?","punchline": "A: They couldn't find any RAM!"},
    {"pun": "Q: Which way did the computer programmer go?","punchline": "A: They went data way!"},
    {"pun": "Q: What do you get when you cross a computer with a hamburger?","punchline": "A: A Big Mac!"},
    ...
    {"pun": "Q: Why don't Vikings like to send emails?","punchline": "A: They prefer to use Norse code!"},
    ...
    {"pun": "Q: Why did the programmer quit their job?","punchline": "A: Because they didn't get arrays!"},
    {"pun": "Q: What do computers and air conditioners have in common?","punchline": "A: They both become useless when you open Windows!"},
    ...
    {"pun": "Q: Did you hear about the monkeys who shared an Amazon account?","punchline": "A: They were Prime mates!"},
    ...
    {"pun": "Q: What do you call it when you have your mom's mom on speed dial?","punchline": "A: Instagram!"},
    ...
    {"pun": "Q: Why are programmers popular on the street?","punchline": "A: They'll write scripts for anything at the right price!"},
    ...
    {"pun": "Q: How many testers does it take to change a light bulb?","punchline": "A: None. Testers do not fix problems; they just report them!"},
    {"pun": "Q: How many programmers does it take to change a light bulb?","punchline": "A: What's the problem? The bulb at my desk works just fine!"},
    ...
    {"pun": "Q: What sits on your shoulder and says 'Pieces of 7! Pieces of 7!'?","punchline": "A Parroty Error!"},
    {"pun": "Q: Why are database admins afraid of having dinner?","punchline": "A: Because the table is cleared!"},
    {"pun": "Q: Who is a computer's favorite singer?","punchline": "A: A Dell!"},
